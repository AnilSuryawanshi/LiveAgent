...
public class LiveChatsMessage {
	...
	public String toString() {
		return "LiveChatsMessage [chatId=" + chatId + ", liveAgentMessage=" + liveAgentMessage + ", userMessage="
				+ userMessage + ", user=" + user + ", currentTime=" + currentTime + ", timeStamp1=" + timeStamp1
				+ ", msgRead=" + msgRead + "]";
	}
